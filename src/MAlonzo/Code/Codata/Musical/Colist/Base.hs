  ...
  = case coe v1 of
      ...
      C__'8759'__30 v2 v3
        -> coe
             ...
             (coe du_'9839''45'0_873 (coe v0) (coe v3))
      _ -> MAlonzo.RTE.mazUnreachableError
  ...
  = case coe v3 of
      ...
      C__'8759'__30 v4 v5
        -> coe
             ...
             (coe du_'9839''45'1_1885 (coe v0) (coe v1) (coe v2) (coe v5))
      _ -> MAlonzo.RTE.mazUnreachableError
...
du_fromList_50 v0 v1
  = case coe v1 of
      ...
      (:) v2 v3
        -> coe
             C__'8759'__30 (coe v2) (coe du_'9839''45'2_3193 (coe v0) (coe v3))
      _ -> MAlonzo.RTE.mazUnreachableError
  ...
  = case coe v1 of
      ...
      MAlonzo.Code.Codata.Musical.Conat.Base.C_suc_14 v3
        -> coe
             ...
             (coe du_'9839''45'3_3927 (coe v0) (coe v3) (coe v2))
      _ -> MAlonzo.RTE.mazUnreachableError
  ...
  = case coe v1 of
      ...
      C__'8759'__30 v3 v4
        -> coe
             ...
             (coe du_'9839''45'4_5783 (coe v0) (coe v4) (coe v2))
      _ -> MAlonzo.RTE.mazUnreachableError
-- Codata.Musical.Colist.Base._⋎_
d__'8910'__82 ::
  MAlonzo.Code.Agda.Primitive.T_Level_18 ->
...
du__'8910'__82 v0 v1 v2
  = case coe v1 of
      ...
      C__'8759'__30 v3 v4
        -> coe
             C__'8759'__30 (coe v3)
             (coe du_'9839''45'5_6743 (coe v0) (coe v4) (coe v2))
      _ -> MAlonzo.RTE.mazUnreachableError
        ...
        -> case coe v2 of
             MAlonzo.Code.Data.List.NonEmpty.Base.C__'8759'__34 v4 v5
               -> case coe v5 of
                    []
                      -> coe
                           C__'8759'__30 (coe v4) (coe du_'9839''45'6_7777 (coe v0) (coe v3))
                    (:) v6 v7
                      -> coe
                           C__'8759'__30 (coe v4)
                           (coe du_'9839''45'7_8317 (coe v0) (coe v6) (coe v7) (coe v3))
                    _ -> MAlonzo.RTE.mazUnreachableError
             _ -> MAlonzo.RTE.mazUnreachableError
      _ -> MAlonzo.RTE.mazUnreachableError
...
du_'91'_'93'_106 v0
  = coe C__'8759'__30 (coe v0) (coe du_'9839''45'8_9487)
...
d_'9839''45'0_873 v0 ~v1 ~v2 v3 = du_'9839''45'0_873 v0 v3
du_'9839''45'0_873 ::
  MAlonzo.Code.Agda.Primitive.T_Level_18 ->
  MAlonzo.RTE.Infinity AgdaAny (T_Colist_20 AgdaAny AgdaAny) ->
  MAlonzo.RTE.Infinity
    AgdaAny MAlonzo.Code.Codata.Musical.Conat.Base.T_Coℕ_8
du_'9839''45'0_873 v0 v1
  = coe
...
d_'9839''45'1_1885 ::
  ...
  MAlonzo.RTE.Infinity AgdaAny (T_Colist_20 AgdaAny AgdaAny) ->
  MAlonzo.RTE.Infinity AgdaAny (T_Colist_20 AgdaAny AgdaAny)
d_'9839''45'1_1885 v0 ~v1 v2 ~v3 v4 ~v5 v6
  = du_'9839''45'1_1885 v0 v2 v4 v6
du_'9839''45'1_1885 ::
  MAlonzo.Code.Agda.Primitive.T_Level_18 ->
  MAlonzo.Code.Agda.Primitive.T_Level_18 ->
  (AgdaAny -> AgdaAny) ->
  MAlonzo.RTE.Infinity AgdaAny (T_Colist_20 AgdaAny AgdaAny) ->
  MAlonzo.RTE.Infinity AgdaAny (T_Colist_20 AgdaAny AgdaAny)
du_'9839''45'1_1885 v0 v1 v2 v3
  = coe
      MAlonzo.Code.Agda.Builtin.Coinduction.C_'9839'__16
      (coe
...
d_'9839''45'2_3193 ::
  ...
  [AgdaAny] ->
  MAlonzo.RTE.Infinity AgdaAny (T_Colist_20 AgdaAny AgdaAny)
d_'9839''45'2_3193 v0 ~v1 ~v2 v3 = du_'9839''45'2_3193 v0 v3
du_'9839''45'2_3193 ::
  MAlonzo.Code.Agda.Primitive.T_Level_18 ->
  [AgdaAny] ->
  MAlonzo.RTE.Infinity AgdaAny (T_Colist_20 AgdaAny AgdaAny)
du_'9839''45'2_3193 v0 v1
  = coe
      MAlonzo.Code.Agda.Builtin.Coinduction.C_'9839'__16
...
d_'9839''45'3_3927 ::
  ...
  AgdaAny ->
  MAlonzo.RTE.Infinity AgdaAny (T_Colist_20 AgdaAny AgdaAny)
d_'9839''45'3_3927 v0 ~v1 v2 v3 = du_'9839''45'3_3927 v0 v2 v3
du_'9839''45'3_3927 ::
  MAlonzo.Code.Agda.Primitive.T_Level_18 ->
  MAlonzo.RTE.Infinity
    AgdaAny MAlonzo.Code.Codata.Musical.Conat.Base.T_Coℕ_8 ->
...
d_'9839''45'4_5783 ::
  ...
  T_Colist_20 AgdaAny AgdaAny ->
  MAlonzo.RTE.Infinity AgdaAny (T_Colist_20 AgdaAny AgdaAny)
d_'9839''45'4_5783 v0 ~v1 ~v2 v3 v4 = du_'9839''45'4_5783 v0 v3 v4
du_'9839''45'4_5783 ::
  MAlonzo.Code.Agda.Primitive.T_Level_18 ->
  MAlonzo.RTE.Infinity AgdaAny (T_Colist_20 AgdaAny AgdaAny) ->
  T_Colist_20 AgdaAny AgdaAny ->
  MAlonzo.RTE.Infinity AgdaAny (T_Colist_20 AgdaAny AgdaAny)
du_'9839''45'4_5783 v0 v1 v2
  = coe
      MAlonzo.Code.Agda.Builtin.Coinduction.C_'9839'__16
      (coe
...
d_'9839''45'5_6743 ::
  ...
  T_Colist_20 AgdaAny AgdaAny ->
  MAlonzo.RTE.Infinity AgdaAny (T_Colist_20 AgdaAny AgdaAny)
d_'9839''45'5_6743 v0 ~v1 ~v2 v3 v4 = du_'9839''45'5_6743 v0 v3 v4
du_'9839''45'5_6743 ::
  MAlonzo.Code.Agda.Primitive.T_Level_18 ->
  MAlonzo.RTE.Infinity AgdaAny (T_Colist_20 AgdaAny AgdaAny) ->
  T_Colist_20 AgdaAny AgdaAny ->
  MAlonzo.RTE.Infinity AgdaAny (T_Colist_20 AgdaAny AgdaAny)
du_'9839''45'5_6743 v0 v1 v2
  = coe
      MAlonzo.Code.Agda.Builtin.Coinduction.C_'9839'__16
      (coe
...
d_'9839''45'6_7777 ::
  ...
  MAlonzo.RTE.Infinity
    ...
    (T_Colist_20
       AgdaAny MAlonzo.Code.Data.List.NonEmpty.Base.T_List'8314'_22) ->
  MAlonzo.RTE.Infinity AgdaAny (T_Colist_20 AgdaAny AgdaAny)
d_'9839''45'6_7777 v0 ~v1 ~v2 v3 = du_'9839''45'6_7777 v0 v3
du_'9839''45'6_7777 ::
  MAlonzo.Code.Agda.Primitive.T_Level_18 ->
  MAlonzo.RTE.Infinity
    AgdaAny
...
d_'9839''45'7_8317 ::
  ...
  MAlonzo.RTE.Infinity
    ...
    (T_Colist_20
       AgdaAny MAlonzo.Code.Data.List.NonEmpty.Base.T_List'8314'_22) ->
  MAlonzo.RTE.Infinity AgdaAny (T_Colist_20 AgdaAny AgdaAny)
d_'9839''45'7_8317 v0 ~v1 ~v2 v3 v4 v5
  = du_'9839''45'7_8317 v0 v3 v4 v5
du_'9839''45'7_8317 ::
  MAlonzo.Code.Agda.Primitive.T_Level_18 ->
  AgdaAny ->
  [AgdaAny] ->
  MAlonzo.RTE.Infinity
    ...
    (T_Colist_20
       AgdaAny MAlonzo.Code.Data.List.NonEmpty.Base.T_List'8314'_22) ->
  MAlonzo.RTE.Infinity AgdaAny (T_Colist_20 AgdaAny AgdaAny)
du_'9839''45'7_8317 v0 v1 v2 v3
  = coe
      MAlonzo.Code.Agda.Builtin.Coinduction.C_'9839'__16
      (coe
         du_concat_92 (coe v0)
...
d_'9839''45'8_9487 ::
  ...
  AgdaAny ->
  MAlonzo.RTE.Infinity AgdaAny (T_Colist_20 AgdaAny AgdaAny)
d_'9839''45'8_9487 ~v0 ~v1 ~v2 = du_'9839''45'8_9487
du_'9839''45'8_9487 ::
  MAlonzo.RTE.Infinity AgdaAny (T_Colist_20 AgdaAny AgdaAny)
du_'9839''45'8_9487
  = coe
